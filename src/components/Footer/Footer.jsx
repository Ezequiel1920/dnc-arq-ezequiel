                ...
                <div className="d-flex jc-space-between mobile-fd-column">
                    ...
                    <div className="d-flex mobile-fd-column">
                        ...
                        <div className="footer-col">
                            ...
                            <p className="gray-1-color">R. Justino Cobra, 61 – Vila Ema | São José dos Campos – SP | CEP 12243-030 suporte@escoladnc.com.br
                                (19) 99187-4342</p>
                            <p className="gray-1-color">suporte@escoladnc.com.br</p>
                            <p className="gray-1-color">suporte@mail.com</p>
